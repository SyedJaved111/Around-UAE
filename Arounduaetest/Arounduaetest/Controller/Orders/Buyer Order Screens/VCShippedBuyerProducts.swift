...
class VCShippedBuyerProducts: BaseController,IndicatorInfoProvider {
...
extension VCShippedBuyerProducts: UITableViewDataSource,UITableViewDelegate{
...
extension VCShippedBuyerProducts: OrderProtocol{
