...
class VCDilverdBuyerProducts: BaseController,IndicatorInfoProvider {
    ...
    private func fetchConfirmListData(isRefresh: Bool){
        ...
        OrderManager().ShowAllCompleted("", status: "completed",successCallback:
...
extension VCDilverdBuyerProducts: UITableViewDataSource,UITableViewDelegate{
